...
*/
typedef std::map<int, std::vector<int>> EdgeGraph;
/*
...
*/
typedef std::map<int, bool> VisitMap; // std::vector<bool> is a C++ sin and we have no way of telling if nodes entered will begin from 0 as well.
